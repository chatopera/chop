...
#
#
# File: /Users/hain/ai/chop/hmm/__init__.py
# Author: Hai Liang Wang
# Date: 2017-07-22:13:44:50
#
#===============================================================================
...
from chop.hmm.train import OUT_OF_OBS
...
class Tokenizer():
    ...
    def __load_metadata(self):
        ...
        '''
        with open(os.path.join(curdir, 'hmm.json'), 'r') as f:
            return json.load(f)
...
def test():
    helper.DEBUG('hmm tokenizer')
    T = Tokenizer()
    helper.DEBUG(' '.join(T.cut('作为市长，我也体会到这种危险。')))
